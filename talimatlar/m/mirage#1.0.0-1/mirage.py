...
if gtk.gtk_version < (2, 10, 0):
	sys.stderr.write("Mirage, GTK + 2.10.0 veya daha yeni bir sürüm gerektirir..\n")
	sys.exit(1)
if gtk.pygtk_version < (2, 12, 0):
	sys.stderr.write("Mirage PyGTK 2.12.0 veya daha yeni bir sürümünü gerektirir.\n")
	sys.exit(1)
...
class Base:
	...
	def __init__(self):
		...
		self.action_names = ["GIMP'te AÇ", "Küçük Resim Oluştur", "Küçük Resim Oluştur", "Favorilere Gönder"]
		...
		actions = (
			('FileMenu', None, _('_Dosya')),
			('EditMenu', None, _('_Düzen')),
			('ViewMenu', None, _('_Görünüm')),
			('GoMenu', None, _('_Git')),
			('HelpMenu', None, _('_Yardım')),
			('ActionSubMenu', None, _('Özel Eylemler')),
			('Open Image', gtk.STOCK_FILE, _('_Resim Aç...'), '<Ctrl>O', _('Resim Aç'), self.open_file),
			('Open Remote Image', gtk.STOCK_NETWORK, _('Uzak Resim Aç...'), None, _('Uzak Resim Aç'), self.open_file_remote),
			('Open Folder', gtk.STOCK_DIRECTORY, _('Klasör Aç...'), '<Ctrl>F', _('Klasör Aç'), self.open_folder),
			('Save', gtk.STOCK_SAVE, _('_Resmi Kaydet'), '<Ctrl>S', _('Resmi Kaydet'), self.save_image),
			('Save As', gtk.STOCK_SAVE, _('Resmi Farklı Kaydet...'), '<Shift><Ctrl>S', _('Resmi Farklı Kaydet'), self.save_image_as),
			('Crop', None, _('_Kırp...'), None, _('Resmi Kırp'), self.crop_image),
			('Resize', None, _('Yeniden Boyutlandır...'), None, _('Resmi Yeniden Boyutlandır'), self.resize_image),
			('Saturation', None, _('_Doygunluğu Değiştir...'), None, _('Doygunluğu Değiştir'), self.saturation),
			('Quit', gtk.STOCK_QUIT, _('_Çıkış'), '<Ctrl>Q', _('Çıkış'), self.exit_app),
			('Previous Image', gtk.STOCK_GO_BACK, _('_Önceki Resim'), 'Left', _('Önceki Resim'), self.goto_prev_image),
			('Next Image', gtk.STOCK_GO_FORWARD, _('_Sonraki Resim'), 'Right', _('Sonraki Resim'), self.goto_next_image),
			('Previous2', gtk.STOCK_GO_BACK, _('_Önceki'), 'Left', _('Önceki'), self.goto_prev_image),
			('Next2', gtk.STOCK_GO_FORWARD, _('_Sonraki'), 'Right', _('Sonraki'), self.goto_next_image),
			('Random Image', None, _('_Rastgele Resim'), 'R', _('Rastgele Resim'), self.goto_random_image),
			('First Image', gtk.STOCK_GOTO_FIRST, _('_İlk Resim'), 'Home', _('İlk Resim'), self.goto_first_image),
			('Last Image', gtk.STOCK_GOTO_LAST, _('_Son Resim'), 'End', _('Son Resim'), self.goto_last_image),
			('In', gtk.STOCK_ZOOM_IN, _('Yakınlaştır'), '<Ctrl>Up', _('Yakınlaştır'), self.zoom_in),
			('Out', gtk.STOCK_ZOOM_OUT, _('Uzaklaştır'), '<Ctrl>Down', _('Uzaklaştır'), self.zoom_out),
			('Fit', gtk.STOCK_ZOOM_FIT, _('Uygun Boyut'), '<Ctrl>0', _('Uygun Boyut'), self.zoom_to_fit_window_action),
			('1:1', gtk.STOCK_ZOOM_100, _('_1:1'), '<Ctrl>1', _('1:1'), self.zoom_1_to_1_action),
			('Rotate Left', None, _('_Sola Döndür'), '<Ctrl>Left', _('Sola Döndür'), self.rotate_left),
			('Rotate Right', None, _('_Sağa Döndür'), '<Ctrl>Right', _('Sağa Döndür'), self.rotate_right),
			('Flip Vertically', None, _('_Dikey Çevir'), '<Ctrl>V', _('Dikey Çevir'), self.flip_image_vert),
			('Flip Horizontally', None, _('_Yatay Çevir'), '<Ctrl>H', _('Yatay Çevir'), self.flip_image_horiz),
			('About', gtk.STOCK_ABOUT, _('_Hakkında'), None, _('Hakkında'), self.show_about),
			('Contents', gtk.STOCK_HELP, _('_İçerik'), 'F1', _('İçerik'), self.show_help),
			('Preferences', gtk.STOCK_PREFERENCES, _('_Seçenekler...'), '<Ctrl>P', _('Seçenekler'), self.show_prefs),
			('Full Screen', fullscreen_icon, _('_Tam Ekran'), 'F11', _('Tam Ekran'), self.enter_fullscreen),
			('Exit Full Screen', leave_fullscreen_icon, _('_Tam Ekrandan Çık'), None, _('Tam Ekrandan Çık'), self.leave_fullscreen),
			('Start Slideshow', gtk.STOCK_MEDIA_PLAY, _('_Slayt Gösterisi Başlat'), 'F5', _('Slayt Gösterisi Başlat'), self.toggle_slideshow),
			('Stop Slideshow', gtk.STOCK_MEDIA_STOP, _('_Slayt Gösterisini Durdur'), 'F5', _('Slayt Gösterisini Durdur'), self.toggle_slideshow),
			('Delete Image', gtk.STOCK_DELETE, _('_Sil...'), 'Delete', _('Resmi Sil'), self.delete_image),
			('Rename Image', None, _('Yeniden Adlandır...'), 'F2', _('Resmi Yeniden Adlandır'), self.rename_image),
			('Take Screenshot', None, _('_Ekran Resmi Al...'), None, _('Ekran Resmi Al'), self.screenshot),
			('Properties', gtk.STOCK_PROPERTIES, _('Seçenekler...'), None, _('Seçenekler'), self.show_properties),
			('Custom Actions', None, _('_Ayarla...'), None, _('Özel Eylemler'), self.show_custom_actions),
			('MiscKeysMenuHidden', None, 'Keys'),
			('Escape', None, '', 'Escape', _('Tam Ekrandan Çık'), self.leave_fullscreen),
			('Minus', None, '', 'minus', _('Uzaklaştır'), self.zoom_out),
			('Plus', None, '', 'plus', _('Yakınlaştır'), self.zoom_in),
			('Equal', None, '', 'equal', _('Yakınlaştır'), self.zoom_in),
			('Space', None, '', 'space', _('Sonraki Resim'), self.goto_next_image),
			('Ctrl-KP_Insert', None, '', '<Ctrl>KP_Insert', _('Uygun Boyut'), self.zoom_to_fit_window_action),
			('Ctrl-KP_End', None, '', '<Ctrl>KP_End', _('1:1'), self.zoom_1_to_1_action),
			('Ctrl-KP_Subtract', None, '', '<Ctrl>KP_Subtract', _('Uzaklaştır'), self.zoom_out),
			('Ctrl-KP_Add', None, '', '<Ctrl>KP_Add', _('Yakınlaştır'), self.zoom_in),
			('Ctrl-KP_0', None, '', '<Ctrl>KP_0', _('Uygun Boyut'), self.zoom_to_fit_window_action),
			('Ctrl-KP_1', None, '', '<Ctrl>KP_1', _('1:1'), self.zoom_1_to_1_action),
			('Full Screen Key', None, '', '<Shift>Return', None, self.enter_fullscreen),
			('Prev', None, '', 'Up', _('Önceki Resim'), self.goto_prev_image),
			('Next', None, '', 'Down', _('Sonraki Resim'), self.goto_next_image),
			('PgUp', None, '', 'Page_Up', _('Önceki Resim'), self.goto_prev_image),
			('PgDn', None, '', 'Page_Down', _('Sonraki Resim'), self.goto_next_image),
			('BackSpace', None, '', 'BackSpace', _('Previous Image'), self.goto_prev_image),
			('OriginalSize', None, '', '1', _('1:1'), self.zoom_1_to_1_action),
			('ZoomIn', None, '', 'KP_Add', _('Yakınlaştır'), self.zoom_in),
			('ZoomOut', None, '', 'KP_Subtract', _('Uzaklaştır'), self.zoom_out)
			)
		toggle_actions = (
			('Status Bar', None, _('_Durum Çubuğu'), None, _('Durum Çubuğu'), self.toggle_status_bar, self.statusbar_show),
			('Toolbar', None, _('_Araç Çubuğu'), None, _('Araç Çubuğu'), self.toggle_toolbar, self.toolbar_show),
			('Thumbnails Pane', None, _('Küçük Resim Bölümü'), None, _('Küçük Resim Bölümü'), self.toggle_thumbpane, self.thumbpane_show)
				)
	...
	def show_custom_actions(self, action):
		...
		instructions = gtk.Label(_("Burada kısayollarla özel eylemleri tanımlayabilirsiniz. Eylemler, aşağıda listelenen yerleşik parametreleri ve işlemleri kullanır ve noktalı virgülle ayrılmış birden çok ifadeye sahip olabilir. Toplu işlemler, listedeki tüm görüntülere uygulanır."))
	...
	def open_custom_action_dialog(self, add_call, name, command, shortcut, batch, treeview):
		...
		action_name_label = gtk.Label(_("İşlem Adı:"))
		action_name_label.set_alignment(0, 0.5)
		action_command_label = gtk.Label(_("Komut:"))
		action_command_label.set_alignment(0, 0.5)
		shortcut_label = gtk.Label(_("Kısayol:"))
	...
	def shortcut_clicked(self, widget):
		self.dialog_shortcut = gtk.Dialog(_("İşlem Kısayolu"), self.dialog_name, gtk.DIALOG_MODAL, (gtk.STOCK_CANCEL, gtk.RESPONSE_REJECT))
	...
	def show_properties(self, action):
		...
		vbox_left = gtk.VBox()
		filename = gtk.Label(_("Dosya Adı:"))
		...
		transparency = gtk.Label(_("Saydamlık:"))
	...
	def show_prefs(self, action):
		...
		self.colorbutton.set_tooltip_text(_("Uygulama için arkaplan rengini ayarlar."))
		...
		simplecolortext = gtk.Label(_('Basit arka plan rengi:'))
		...
		fullscreen = gtk.CheckButton(_("Mirage'ı tam ekran modunda aç"))
		fullscreen.set_active(self.start_in_fullscreen)
		thumbbox = gtk.HBox()
		thumblabel = gtk.Label(_("Küçük resim boyutu:"))
		...
		openlabel = gtk.Label()
		openlabel.set_markup('<b>' + _('Davranışı aç') + '</b>')
		openlabel.set_alignment(0, 1)
		hbox_openmode = gtk.HBox()
		hbox_openmode.pack_start(gtk.Label(_('Yeni Resim Aç:')), False, False, 0)
		combobox = gtk.combo_box_new_text()
		combobox.append_text(_("Akıllı Mod"))
		combobox.append_text(_("Uygun Boyut Modu"))
		combobox.append_text(_("1:1 Mod"))
		combobox.append_text(_("Son Aktif Mod"))
		combobox.set_active(self.open_mode)
		hbox_openmode.pack_start(combobox, False, False, 5)
		openallimages = gtk.CheckButton(_("Tüm resimleri geçerli dizine yükle"))
		openallimages.set_active(self.open_all_images)
		openallimages.set_tooltip_text(_("Etkinleştirilirse, Mirage'da bir görüntü açınca, o görüntü dizininde bulunan tüm görüntüleri otomatik olarak yükler."))
		hiddenimages = gtk.CheckButton(_("Gizli dosyaları yüklemeye izin ver"))
		hiddenimages.set_active(self.open_hidden_files)
		hiddenimages.set_tooltip_text(_("İşaretlenirse, Mirage gizli dosyaları açacaktır. Aksi halde, gizli dosyalar göz ardı edilir."))
		openpref = gtk.RadioButton()
		openpref1 = gtk.RadioButton(group=openpref, label=_("Son seçilen dizini kullan"))
		openpref1.set_tooltip_text(_("Varsayılan 'Open' dizini kullanılan son dizin olacaktır."))
		openpref2 = gtk.RadioButton(group=openpref, label=_("Bu sabit dizini kullan:"))
		openpref2.connect('toggled', self.prefs_use_fixed_dir_clicked)
		openpref2.set_tooltip_text(_("Varsayılan 'Açık' dizin belirtilen dizin olacaktır."))
		...
		navlabel = gtk.Label()
		navlabel.set_markup('<b>' + _('Gezinme') + '</b>')
		navlabel.set_alignment(0, 1)
		preloadnav = gtk.CheckButton(label=_("Daha hızlı gezinme için görüntüleri önceden yükleyin"))
		preloadnav.set_active(self.preloading_images)
		preloadnav.set_tooltip_text(_("Etkinleştirilirse, listedeki sonraki ve önceki görüntüler boşta kalma süresi boyunca önceden yüklenir. Hız artışının bellek kullanımı pahasına olduğunu unutmayın, bu nedenle bu seçeneği sınırlı ram olan makinelerde devre dışı bırakmanız önerilir."))
		hbox_listwrap = gtk.HBox()
		hbox_listwrap.pack_start(gtk.Label(_("Görselin etrafına sar:")), False, False, 0)
		combobox2 = gtk.combo_box_new_text()
		combobox2.append_text(_("Hayır"))
		combobox2.append_text(_("Evet"))
		...
		slideshowlabel.set_markup('<b>' + _('Slayt Gösterisi Modu') + '</b>')
		slideshowlabel.set_alignment(0, 1)
		hbox_delay = gtk.HBox()
		hbox_delay.pack_start(gtk.Label(_("Saniyede resimler arasında gecikme:")), False, False, 0)
		...
		randomize = gtk.CheckButton(_("Görüntülerin sırasını sırala"))
		randomize.set_active(self.slideshow_random)
		randomize.set_tooltip_text(_("Etkinleştirildiğinde, slayt gösterisi sırasında rastgele bir resim seçilecektir (herhangi bir görüntüyü iki kez yüklemeden)."))
		disable_screensaver = gtk.CheckButton(_("Slayt gösterisi modunda ekran koruyucuyu devre dışı bırak"))
		...
		ss_in_fs = gtk.CheckButton(_("Her zaman tam ekran modunda başlat"))
		ss_in_fs.set_tooltip_text(_("Etkinleştirildiğinde, bir slayt gösterisi başlatılması uygulamayı tam ekran moduna geçirir."))
		...
		imagelabel.set_markup('<b>' + _('Resim Düzenleme') + '</b>')
		imagelabel.set_alignment(0, 1)
		deletebutton = gtk.CheckButton(_("Resim silmeyi onayla"))
		deletebutton.set_active(self.confirm_delete)
		
		zoom_hbox = gtk.HBox()
		zoom_hbox.pack_start(gtk.Label(_('Ölçekleme kalitesi:')), False, False, 0)
		...
		savecombo.append_text(_("Oto-Kaydet"))
		...
		notebook.append_page(table_behavior, gtk.Label(_("Davranış")))
		notebook.append_page(table_navigation, gtk.Label(_("Gezinti")))
		notebook.append_page(table_settings, gtk.Label(_("Arayüz")))
		notebook.append_page(table_slideshow, gtk.Label(_("Slayt Görüntüsü")))
		notebook.append_page(table_image, gtk.Label(_("Resim")))
	...
	def rename_image(self, action):
		if len(self.image_list) > 0:
			...
			if self.slideshow_mode:
				self.toggle_slideshow(None)
			rename_dialog = gtk.Dialog(_('Resmi Yeniden Adlandır'), self.window, gtk.DIALOG_MODAL)
			...
			renamebutton = rename_dialog.add_button(_("_Yeniden Adlandır"), gtk.RESPONSE_ACCEPT)
			...
			instructions = gtk.Label(_("Yeni adı giriniz:"))
			...
			if response == gtk.RESPONSE_ACCEPT:
				try:
					...
					error_dialog = gtk.MessageDialog(self.window, gtk.DIALOG_MODAL, gtk.MESSAGE_WARNING, gtk.BUTTONS_OK, _('%s yeniden adlandırılamıyor') % self.currimg_name)
					error_dialog.set_title(_("Yeniden adlandırılamıyor"))
					error_dialog.run()
					error_dialog.destroy()
	...
	def delete_image(self, action):
		if len(self.image_list) > 0:
			...
			if self.slideshow_mode:
				self.toggle_slideshow(None)
			delete_dialog = gtk.Dialog(_('Resmi Sil'), self.window, gtk.DIALOG_MODAL)
			if self.confirm_delete:
				permlabel = gtk.Label(_('%s kalıcı olarak silinecek onaylıyor musunuz??') % os.path.split(self.currimg_name)[1])
			...
			if response  == gtk.RESPONSE_YES:
				try:
					...
					error_dialog = gtk.MessageDialog(self.window, gtk.DIALOG_MODAL, gtk.MESSAGE_WARNING, gtk.BUTTONS_OK, _('%s silinemedi') % self.currimg_name)
					error_dialog.set_title(_("Silinemedi"))
					error_dialog.run()
					error_dialog.destroy()
	...
	def defaultdir_clicked(self, button):
		getdir = gtk.FileChooserDialog(title=_("Dizin Seçimi"),action=gtk.FILE_CHOOSER_ACTION_OPEN,buttons=(gtk.STOCK_CANCEL,gtk.RESPONSE_CANCEL,gtk.STOCK_OPEN,gtk.RESPONSE_OK))
	...
	def show_about(self, action):
		...
		self.about_dialog.set_comments(_('Hızlı Resim Görüntüleyici.\nTürkçe Çeviri: Cihan Alkan'))
					...
					try:
						...
						try:
							...
							try:
								...
								error_dialog = gtk.MessageDialog(self.window, gtk.DIALOG_MODAL, gtk.MESSAGE_WARNING, gtk.BUTTONS_CLOSE, _('Uygun bir tarayıcı başlatılamıyor.'))
								error_dialog.run()
								error_dialog.destroy()
	...
	def image_load_failed(self, reset_cursor, filename=""):
		...
		if self.verbose and self.currimg_name != "":
			print _("Yükleniyor: %s") % self.currimg_name
		self.update_title()
	...
	def update_title(self):
		if len(self.image_list) == 0:
			...
			if self.slideshow_mode:
				title = title + ' - ' + _('Slayt Gösterisi Modu')
